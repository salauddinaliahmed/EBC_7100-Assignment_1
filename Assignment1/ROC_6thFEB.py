...
clf = svm.SVC()
svm_bow = clf.fit(x_train, y_train)
...
svm_tfidf = clf_svm.fit(x_train, y_train,)
...
def roc_plot(svm_model, x_test, y_test, df_y):
...
roc_plot(svm_bow, x_test, y_test, df_y)
roc_plot(svm_tfidf,x_test, y_test, df_y)
